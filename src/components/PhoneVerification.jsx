          ...
          {!isVerified && !isCodeSent ? (
            <>
              <form onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className={`w-full py-2 px-4 bg-primary text-white rounded-md hover:bg-primry/50 disabled:bg-blue-500`}
                  disabled={isLoading}
                >
            ...
            <>
              <form onSubmit={handleVerifyCode}>
                ...
                <button type="submit" className="w-full py-2 px-4 bg-primary text-white rounded-md hover:bg-primary/80">
                  Verify Code
                </button>
              </form>
